...
const MAPBOX_TOKEN =
  ...
  // now changed 20250826
  'pk.eyJ1IjoiaGFpeWFua29uZyIsImEiOiJjbWVzM2IzYXMwZGxyMmxwdGtkZDV5azRpIn0.BCaNDxcG7avCJlZVfTq8SA';
...
export const MAIN_COLOR = '#122034';
export const RUN_COLOR = nike;
export const RIDE_COLOR = '#28A979';
export const VIRTUAL_RIDE_COLOR = '#7C5CFF';
export const HIKE_COLOR = '#B7791F';
export const SWIM_COLOR = '#00A0B5';
export const ROWING_COLOR = bluegreen;
export const ROAD_TRIP_COLOR = '#F05A3E';
export const FLIGHT_COLOR = veryPeri;
export const KAYAKING_COLOR = cyan;
export const WORKOUT_COLOR = '#F2B84B'; // khy add 20250224
export const PROVINCE_FILL_COLOR = '#74C0FC';
export const COUNTRY_FILL_COLOR = '#D9E8E4';
